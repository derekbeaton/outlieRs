...
idOutliers <- function(
  ...
  rmdo_nsamp = 100, # number of iterations - same as nsamp in getRMDO.  "best" would be long but potentially do more than default of 500
  nsamps=100, # number of elements within each sample
